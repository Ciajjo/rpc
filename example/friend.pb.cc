...
const uint32_t TableStruct_friend_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendsRequest, _impl_.userid_),
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_friend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "Code\022\017\n\007friends\030\002 \003(\0142U\n\nGetFriends\022G\n\016G"
  "etFriendsList\022\031.fixbug.GetFriendsRequest"
  "\032\032.fixbug.GetFriendsResponseB\003\200\001\001b\006proto"
  "3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* GetFriends::descriptor() {
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* GetFriends::GetDescriptor() {
  return descriptor();
}

void GetFriends::GetFriendsList(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
void GetFriends::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
...
const ::PROTOBUF_NAMESPACE_ID::Message& GetFriends::GetRequestPrototype(
...
const ::PROTOBUF_NAMESPACE_ID::Message& GetFriends::GetResponsePrototype(
    const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method) const {
  GOOGLE_DCHECK_EQ(method->service(), descriptor());
  switch(method->index()) {
    case 0:
...
GetFriends_Stub::GetFriends_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel)
  : channel_(channel), owns_channel_(false) {}
GetFriends_Stub::GetFriends_Stub(
...
void GetFriends_Stub::GetFriendsList(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
