...
class GetFriends_Stub;

class GetFriends : public ::PROTOBUF_NAMESPACE_ID::Service {
 protected:
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(GetFriends);
};

class GetFriends_Stub : public GetFriends {
 public:
  GetFriends_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel);
  GetFriends_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel,
 ...
 private:
  ...
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(GetFriends_Stub);
};
...
// uint32 userid = 1;
inline void GetFriendsRequest::clear_userid() {
  _impl_.userid_ = 0u;
}
inline uint32_t GetFriendsRequest::_internal_userid() const {
  return _impl_.userid_;
}
inline uint32_t GetFriendsRequest::userid() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendsRequest.userid)
  return _internal_userid();
}
inline void GetFriendsRequest::_internal_set_userid(uint32_t value) {
  
  _impl_.userid_ = value;
}
inline void GetFriendsRequest::set_userid(uint32_t value) {
  _internal_set_userid(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendsRequest.userid)
}
