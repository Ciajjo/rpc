...
constexpr User_Sex User_Sex_Sex_MAX = User_Sex_WUMAN;
...
// .fixbug.ResultCode resultCode = 1;
inline bool GetfriendListResponse::_internal_has_resultcode() const {
  return this != internal_default_instance() && _impl_.resultcode_ != nullptr;
}
inline bool GetfriendListResponse::has_resultcode() const {
  return _internal_has_resultcode();
}
inline void GetfriendListResponse::clear_resultcode() {
  if (GetArenaForAllocation() == nullptr && _impl_.resultcode_ != nullptr) {
    delete _impl_.resultcode_;
  }
  _impl_.resultcode_ = nullptr;
}
inline const ::fixbug::ResultCode& GetfriendListResponse::_internal_resultcode() const {
  const ::fixbug::ResultCode* p = _impl_.resultcode_;
  return p != nullptr ? *p : reinterpret_cast<const ::fixbug::ResultCode&>(
      ::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& GetfriendListResponse::resultcode() const {
  // @@protoc_insertion_point(field_get:fixbug.GetfriendListResponse.resultCode)
  return _internal_resultcode();
}
inline void GetfriendListResponse::unsafe_arena_set_allocated_resultcode(
    ::fixbug::ResultCode* resultcode) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.GetfriendListResponse.resultCode)
}
inline ::fixbug::ResultCode* GetfriendListResponse::release_resultcode() {
...
inline ::fixbug::ResultCode* GetfriendListResponse::unsafe_arena_release_resultcode() {
  // @@protoc_insertion_point(field_release:fixbug.GetfriendListResponse.resultCode)
  
  ::fixbug::ResultCode* temp = _impl_.resultcode_;
  _impl_.resultcode_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetfriendListResponse::_internal_mutable_resultcode() {
...
inline ::fixbug::ResultCode* GetfriendListResponse::mutable_resultcode() {
  ::fixbug::ResultCode* _msg = _internal_mutable_resultcode();
  // @@protoc_insertion_point(field_mutable:fixbug.GetfriendListResponse.resultCode)
  return _msg;
}
inline void GetfriendListResponse::set_allocated_resultcode(::fixbug::ResultCode* resultcode) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.resultcode_;
  }
  ...
  _impl_.resultcode_ = resultcode;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetfriendListResponse.resultCode)
}
