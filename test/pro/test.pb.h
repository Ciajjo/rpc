...
// int32 errnum = 1;
inline void LoginResponse::clear_errnum() {
  _impl_.errnum_ = 0;
}
inline int32_t LoginResponse::_internal_errnum() const {
  return _impl_.errnum_;
}
inline int32_t LoginResponse::errnum() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginResponse.errnum)
  return _internal_errnum();
}
inline void LoginResponse::_internal_set_errnum(int32_t value) {
  
  _impl_.errnum_ = value;
}
inline void LoginResponse::set_errnum(int32_t value) {
  _internal_set_errnum(value);
  // @@protoc_insertion_point(field_set:fixbug.LoginResponse.errnum)
}
