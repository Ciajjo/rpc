...
static ::_pb::Metadata file_level_metadata_rpcprovider_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_rpcprovider_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_rpcprovider_2eproto = nullptr;

const uint32_t TableStruct_rpcprovider_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::mprpc::RpcHeader, _impl_.argcsize_),
};
...
const char descriptor_table_protodef_rpcprovider_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021rpcprovider.proto\022\005mprpc\"F\n\tRpcHeader\022"
  "\023\n\013serviceName\030\001 \001(\014\022\022\n\nmethodName\030\002 \001(\014"
  "\022\020\n\010argcSize\030\003 \001(\rb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_rpcprovider_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_rpcprovider_2eproto = {
    false, false, 106, descriptor_table_protodef_rpcprovider_2eproto,
    "rpcprovider.proto",
    &descriptor_table_rpcprovider_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_rpcprovider_2eproto::offsets,
    file_level_metadata_rpcprovider_2eproto, file_level_enum_descriptors_rpcprovider_2eproto,
    file_level_service_descriptors_rpcprovider_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_rpcprovider_2eproto_getter() {
  return &descriptor_table_rpcprovider_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_rpcprovider_2eproto(&descriptor_table_rpcprovider_2eproto);
namespace mprpc {
...
RpcHeader::RpcHeader(const RpcHeader& from)
  ...
  _this->_impl_.argcsize_ = from._impl_.argcsize_;
...
void RpcHeader::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_argcsize() != 0) {
    _this->_internal_set_argcsize(from._internal_argcsize());
  }
...
::PROTOBUF_NAMESPACE_ID::Metadata RpcHeader::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_rpcprovider_2eproto_getter, &descriptor_table_rpcprovider_2eproto_once,
      file_level_metadata_rpcprovider_2eproto[0]);
}
