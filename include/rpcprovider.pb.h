...
#ifndef GOOGLE_PROTOBUF_INCLUDED_rpcprovider_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_rpcprovider_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_rpcprovider_2eproto
...
struct TableStruct_rpcprovider_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_rpcprovider_2eproto;
namespace mprpc {
class RpcHeader;
...
class RpcHeader final :
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_rpcprovider_2eproto;
};
// ===================================================================
...
inline uint32_t RpcHeader::argcsize() const {
  // @@protoc_insertion_point(field_get:mprpc.RpcHeader.argcSize)
...
inline void RpcHeader::set_argcsize(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:mprpc.RpcHeader.argcSize)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_rpcprovider_2eproto
